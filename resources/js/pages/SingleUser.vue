      ...
      <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
          ...
          <div class="modal-body">
            Puoi ordinare da un ristorante alla volta!<br />
            Svuota il carrello se vuoi proseguire gli acquisti presso questo
            ristorante.
          </div>
          ...
          <div class="col-md-7 col-lg-6 col-xl-5">
            <div class="rounded py-3 px-4 carrello">
              ...
              >
                ...
                <div class="mt-5 mb-2">
                  <div class="my-3">Spedizione: {{ shippingCost }} €</div>
