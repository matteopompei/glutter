    ...
    <div class="container">
        ...
        <form action="{{ route('auth.dish.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control @error('ingredients') is-invalid @enderror" id="ingredients" name="ingredients" rows="30"
            ...
            <div class="text-center">
                <a href="{{ route('auth.dish.index') }}"><button type="button" class="btn btn-secondary">Torna alla
                        home</button></a>
            </div>
        </form>
    </div>
