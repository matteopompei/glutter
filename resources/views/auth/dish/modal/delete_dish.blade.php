<form action="{{ route('auth.dish.destroy', $dish) }}" method="POST" enctype="multipart/form-data">
    <div class="modal fade" id="ModalModal{{$dish->id}}" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body text-center">
                    ...
                    <form action="{{ route('auth.dish.destroy', $dish) }}" method="post">
                        @csrf
                        @method("DELETE")
