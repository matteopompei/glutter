      ...
      <div class="row">
        <div class="col">
          <div class="title mb-5">
            <h1><i class="fa-solid fa-angle-right"></i> Registrati</h1>
          </div>
        </div>
      </div>
      <div class="row">
            ...
            <div class="form-group row">
              ...
              <div class="col-md-6">
                <input id="business_name" type="text" class="form-control @error('business_name') is-invalid @enderror"
                  name="business_name" value="{{ old('business_name') }}" minlength="3" required>
            ...
            <div class="form-group row">
              ...
              <div class="col-md-6">
                <input id="p_iva" type="text" class="form-control @error('p_iva') is-invalid @enderror" name="p_iva"
                  value="{{ old('p_iva') }}" minlength="11" maxlength="11" required>
